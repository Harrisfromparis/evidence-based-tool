...
Generated by Autism & Me - Evidence-Based Practice Navigator
    `.trim()
...
Generated by Autism & Me - Evidence-Based Practice Navigator
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-soft-orange/30 border-accent/20">
        <CardHeader>
              ...
              <div className="space-y-4">
                {viewingProfile.strengths && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap bg-soft-green/20 p-3 rounded-lg">{viewingProfile.strengths}</p>
                  </div>
                )}
                ...
                {viewingProfile.interests && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap bg-soft-orange/20 p-3 rounded-lg">{viewingProfile.interests}</p>
                  </div>
                )}
                
                {viewingProfile.sensoryPreferences && (
                  <div>
                    <h3 className="font-semibold mb-2">Sensory Preferences</h3>
                    <p className="text-sm whitespace-pre-wrap bg-muted p-3 rounded-lg">{viewingProfile.sensoryPreferences}</p>
                  </div>
                )}
                
                {viewingProfile.communicationMethods && (
                  <div>
                    <h3 className="font-semibold mb-2">Communication Methods</h3>
                    <p className="text-sm whitespace-pre-wrap bg-muted p-3 rounded-lg">{viewingProfile.communicationMethods}</p>
                  </div>
                )}
                
                {viewingProfile.supportsWork && (
                  <div>
                    <h3 className="font-semibold mb-2">Supports That Work Well</h3>
                    <p className="text-sm whitespace-pre-wrap bg-soft-green/20 p-3 rounded-lg">{viewingProfile.supportsWork}</p>
                  </div>
                )}
                
                {viewingProfile.supportsDontWork && (
                  <div>
                    <h3 className="font-semibold mb-2">Supports That Do Not Work Well</h3>
                    <p className="text-sm whitespace-pre-wrap bg-destructive/10 p-3 rounded-lg">{viewingProfile.supportsDontWork}</p>
                  </div>
                )}
                ...
                {viewingProfile.notes && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap bg-muted p-3 rounded-lg">{viewingProfile.notes}</p>
                  </div>
                )}
              </div>
