...
**Cboard AAC Integration** [IMPLEMENTED]
- Functionality: Full integration of Cboard (cboard.io), a free and open-source AAC (Augmentative and Alternative Communication) web application. Provides symbol-based communication boards with text-to-speech, multi-language support (including Irish and UK English), customizable boards, and offline capability. Comprehensive guide with overview, setup instructions, EBP connections, best practice tips, and both embedded and external launch options.
- Purpose: Provide educators and families with immediate access to a professional-grade AAC tool at no cost. Support non-verbal and minimally verbal autistic students with functional communication through evidence-based AAC systems. Bridge the gap between AAC as an EBP concept and practical implementation tools.
- Trigger: User navigates to "Tools" section → Selects "Cboard AAC App"
- Progression: View introduction to Cboard → Explore four tabs (Overview, Setup Guide, EBP Connections, Launch App) → Overview shows key features and use cases → Setup Guide provides 5-step quick start with best practice tips (modeling, wait time, honoring attempts, consistent access, presuming competence) → EBP Connections explains how Cboard supports FCT, AAC, Visual Supports, and Naturalistic Intervention → Launch App tab offers embedded iframe or external window launch → Launch Cboard directly within platform or in separate window → Use Cboard's pre-built boards or create custom boards (optional account) → Information about privacy, GDPR compliance, language settings, offline use, and customization options
- Success criteria: Cboard launches reliably in both embedded and external modes; comprehensive guidance covers setup, implementation, and ethical use; clear connections to relevant EBPs; emphasis on neuro-affirming AAC practices (modeling, presuming competence, honoring all communication); links to related Autism and Me tools; privacy and data protection information prominent; works across devices; embedded version functional for demos; external launch recommended for classroom use

**Open-Source Tools Library** [IMPLEMENTED]
- Functionality: Comprehensive library of free, open-source software tools supporting autistic individuals across learning, communication, creativity, and gaming. Features 7+ tools including GCompris, Khan Academy, Scratch, Code.org, Cboard, Tux Paint, and Minetest. Each tool includes detailed information about features, autism-specific support, EBP connections, and setup guidance. Organized by category (Education, Communication, Creative, Gaming) with filtering and search.
- Purpose: Provide educators with curated, evidence-based, free technology tools that support autistic learners. Eliminate barriers of cost, geographic restrictions, and data privacy concerns. Connect open-source tools to evidence-based practices and explain specifically why each tool works for autistic learners.
- Trigger: User navigates to "Tools" section → Selects "Open-Source Tools Library"
- Progression: View library overview and category filters → Browse all tools or filter by category (All/Education/Communication/Creative/Gaming) → Select tool card → View comprehensive tool details across 4 tabs (Features, Autism Support, EBP Connections, Setup Guide) → Features tab lists key capabilities → Autism Support tab explains why tool works for autistic learners with specific examples → EBP Connections tab shows related evidence-based practices → Setup Guide tab provides access instructions and direct link to launch tool → Launch tool in new window
- Success criteria: All 7+ tools documented with complete information; clear explanations of autism-specific benefits; accurate EBP connections; direct links to all tools working reliably; category filtering functions correctly; tool cards show key information at a glance; emphasis on privacy, safety, and free/open-source nature; setup instructions are actionable; external links open in new windows; tracking of tool views in analytics

**Parent Technology Guide** [IMPLEMENTED]
- Functionality: Dedicated parent-facing guide for 4 key open-source tools (GCompris, Cboard, Scratch, Khan Academy) with comprehensive instructions for home use. Each tool guide includes: why it helps autistic children, step-by-step getting started instructions, practical home use tips, best-for scenarios, and safety/privacy information. Written in warm, accessible language specifically for parents and caregivers.
- Purpose: Bridge school and home by empowering parents with accessible guidance for implementing evidence-based technology tools at home. Reduce barriers to technology adoption by providing parent-friendly explanations of setup, benefits, and safety considerations. Support continuity of learning and communication supports across school and home environments.
- Trigger: User navigates to "Parents" tab → Selects "Tech Guide" tab
- Progression: View overview of 4 featured tools → Select tool card → View comprehensive parent guide across 4 tabs (Why It Helps, Getting Started, Using at Home, Safety & Privacy) → Why It Helps explains benefits for autistic children and best-for scenarios → Getting Started provides numbered step-by-step setup instructions with parent-friendly language → Using at Home offers practical integration tips for daily routines → Safety & Privacy addresses security, privacy, and safety considerations → Access tool website directly from guide → Return to tool list or navigate to another tool
- Success criteria: All 4 tools have complete parent guides; language is warm, accessible, and free of jargon; step-by-step instructions are actionable for non-technical parents; emphasis on child agency and neuro-affirming use; safety and privacy information prominently displayed; direct links to tools working reliably; guides organized in Parent Hub alongside other parent resources; visual design uses warm colors and handwritten fonts matching Parent Hub aesthetic
